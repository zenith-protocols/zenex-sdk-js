...
describe('package root exports', () => {
    ...
    it('exports the errors and response parsing surface', () => {
        ...
        expect(SDK.ContractErrorType.InvalidConfig).toBe(700);
        expect(SDK.ContractErrorType.TooManyOrders).toBe(733);
        expect(SDK.ContractErrorType.UnknownKind).toBe(734);
        expect(SDK.ContractErrorType.MinOutNotMet).toBe(752);
        expect(SDK.ContractErrorType.PendingPnlExceeded).toBe(754);
        expect(SDK.ContractErrorType.PositionLiquidatable).toBe(723);
        expect(SDK.ContractErrorType.VaultInsolvent).toBe(755);
        expect(SDK.ContractErrorType.AdlNotEligible).toBe(772);
        ...
        expect(SDK.ContractErrorType.QuoteInvalidInput).toBe(-1001);
        expect(SDK.ContractErrorType.QuoteOverflow).toBe(-1002);
